          ...
          <div className="mt-4">
            ...
            {result?.["Test Result"] === "Failed" && (
              <div className="mt-4 p-4 bg-red-100 border border-red-300 rounded-md">
                ...
                <ul className="list-disc list-inside text-black-600">
                  <li>Review employee eligibility criteria to ensure minimum participation is met.</li>
                  <br />
                  <li>Adjust plan design to include a broader employee base.</li>
                  <br />
                  <li>Ensure compliance with SIMPLE Cafeteria Plan requirements as outlined in IRC § 125(j).</li>
                </ul>
              </div>
            )}
            ...
            {result?.["Test Result"] === "Failed" && (
              <div className="mt-4 p-4 bg-yellow-100 border border-yellow-300 rounded-md">
                ...
                <ul className="list-disc list-inside text-black-600">
                  <li>❌ Loss of Safe Harbor status for the plan.</li>
                  <br />
                  <li>❌ Potential reclassification of benefits as taxable.</li>
                  <br />
                  <li>❌ Increased compliance and administrative burdens.</li>
                </ul>
              </div>
            )}
          </div>
