...
export default function DCAPTests() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center py-16 px-6">
      <h1 className="text-5xl font-light text-[#0074d9] mb-8">Dependent Care Assistance Program (DCAP)</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl">
        ...
        <div className="bg-gray-100 rounded-lg shadow p-8 flex flex-col h-full justify-between items-center text-center">
          <div>
            ...
            <p className="text-gray-700 text-sm mt-4">
              Ensure that a DCAP does not disproportionately benefit Key Employees, such as company owners and high-level executives.
            </p>
          </div>
        ...
        <div className="bg-gray-100 rounded-lg shadow p-8 flex flex-col h-full justify-between items-center text-center">
          <div>
            ...
            <p className="text-gray-700 text-sm mt-4">
              Ensures that the average benefits received by Non-HCEs is at least 55% of the average benefits received by Highly Compensated Employees.
            </p>
          </div>
