...
const TopHeavyTest = () => {
  ...
  return (
    <div className="max-w-lg mx-auto mt-10 p-8 bg-white shadow-lg rounded-lg border border-gray-200">
      <h2 className="text-2xl font-bold text-center text-gray-700 mb-6">📂 Upload Top Heavy Test File</h2>
      ...
      {result && (
        <div className="mt-6 p-5 bg-gray-50 border border-gray-300 rounded-lg">
          ...
          <div className="mt-4">
            <p><strong>Total Plan Assets:</strong> ${result?.["Total Plan Assets"] ?? "N/A"}</p>
            <p><strong>Key Employee Assets:</strong> ${result?.["Key Employee Assets"] ?? "N/A"}</p>
            <p><strong>Top Heavy Percentage:</strong> {result?.["Top Heavy Percentage"] ?? "N/A"}%</p>
            ...
            {/* Corrective Actions for Top Heavy Test */}
            {result?.["Test Result"] === "Failed" && (
              <div className="mt-4 p-4 bg-red-100 border border-red-300 rounded-md">
                ...
                <ul className="list-disc list-inside text-black-600">
                  ...
                  <br />
                  <li>Review contribution allocations to ensure compliance with IRS § 416.</li>
                  <br />
                  <li>Adjust plan design to include Safe Harbor provisions if possible.</li>
                </ul>
              </div>
            )}

            {/* Consequences of Top Heavy Failure */}
            {result?.["Test Result"] === "Failed" && (
              <div className="mt-4 p-4 bg-yellow-100 border border-yellow-300 rounded-md">
                ...
                <ul className="list-disc list-inside text-black-600">
                  ...
                  <br />
                  <li>❌ Loss of plan tax advantages if compliance is not corrected.</li>
                  <br />
                  <li>❌ Increased IRS scrutiny and audit risk.</li>
                  <br />
                  <li>❌ Additional penalties or employee disqualification risks.</li>
                </ul>
              </div>
            )}
          </div>
