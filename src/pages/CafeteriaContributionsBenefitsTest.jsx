  ...
  return (
    <div className="max-w-lg mx-auto mt-10 p-8 bg-white shadow-lg rounded-lg border border-gray-200">
      <h2 className="text-2xl font-bold text-center text-gray-700 mb-6">
        📂 Upload Cafeteria Contributions & Benefits Test File
      </h2>
      ...
      {result && (
        <div className="mt-6 p-5 bg-gray-50 border border-gray-300 rounded-lg">
          ...
          <div className="mt-4">
            <p>
              <strong>Employer Contributions (Avg):</strong>{" "}
              {result?.["Employer Contributions (Avg)"] ?? "N/A"}
            </p>
            <p>
              <strong>Employee Contributions (Avg):</strong>{" "}
              {result?.["Employee Contributions (Avg)"] ?? "N/A"}
            </p>
            <p>
              <strong>Total Contributions:</strong>{" "}
              {result?.["Total Contributions"] ?? "N/A"}
            </p>
            <p>
              <strong>Benefits Provided:</strong>{" "}
              {result?.["Benefits Provided"] ?? "N/A"}
            </p>
            <p>
