...
const ACPTest = () => {
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      pdf.text(
       "Test Criterion: IRC §401(m)(2): The ACP (Actual Contribution Percentage) test ensures that employer matching and employee after-tax contributions made for Highly Compensated Employees (HCEs) are not disproportionately higher than those made for Non-Highly Compensated Employees (NHCEs), based on specific percentage limits.",
        105,
        38,
