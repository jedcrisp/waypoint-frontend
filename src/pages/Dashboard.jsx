...
const dashboardItems = [
  ...
  },
  {
    title: "Tests",
    route: "/home",
    description: "Start or continue available nondiscrimination tests",
    icon: FileText,
  },
  {
    title: "Test History",
    route: "/test-history",
    description: "View saved and past test results",
    icon: History,
  },
  {
    title: "Test Info",
    route: "/test-info",
    description: "Overview of test types and their use",
    icon: BookOpen,
  },
  {
    title: "About",
...
export default function Dashboard() {
  ...
  // Fallback to auth.displayName if Firestore doesn't have a firstName
  const displayName = firstName || currentUser?.displayName || "User";
