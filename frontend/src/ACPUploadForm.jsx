...
const ACPUploadForm = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      console.log("🚀 Uploading file to API:", "http://127.0.0.1:8000/upload-acp/");
      console.log("📂 File Selected:", file.name);

      const response = await axios.post("http://127.0.0.1:8000/upload-acp/", formData, {
          ...
          <div className="mt-4">
            <p className="text-lg">
              ...
              <span className="font-semibold text-blue-600">
                {result["HCE_Average_Contribution (%)"] ?? "N/A"}%
              </span>
            </p>
            ...
            <p className="text-lg mt-2">
              ...
              <span className="font-semibold text-green-600">
                {result["NHCE_Average_Contribution (%)"] ?? "N/A"}%
              </span>
            </p>
