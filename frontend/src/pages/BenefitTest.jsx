...
const BenefitTest = () => {
  ...
  // Setup dropzone with noClick and noKeyboard so default click/keyboard actions don't trigger the file picker
  ...
  const handleUpload = async () => {
    ...
    try {
      console.log("🚀 Uploading file to API:", "http://127.0.0.1:8000/upload-csv/benefit");
      console.log("📂 File Selected:", file.name);
      const response = await axios.post(
        "http://127.0.0.1:8000/upload-csv/benefit",
        formData,
